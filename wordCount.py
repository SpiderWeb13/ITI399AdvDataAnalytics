#Write a program to print the count of the number of words in the text below.
#Upload your finished script to Github and use its URL for your assignment submission.

paragraph = '''A CerTaiN kING HaD a bEaUtIFul gaRDEn, ANd IN THe GarDen StooD A trEe
